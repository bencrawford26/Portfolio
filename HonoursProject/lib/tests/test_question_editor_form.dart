...
class TestQuestionEditorForm extends StatefulWidget {
  final User _user;
  ...
  TestQuestionEditorForm(this._user, this._questionMap, this._questionNo,
      this._bank, this.firestore);

  @override
  State<StatefulWidget> createState() {
    return TestQuestionEditorFormState();
  }
}

class TestQuestionEditorFormState extends State<TestQuestionEditorForm> {
